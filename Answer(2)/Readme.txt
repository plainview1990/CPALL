...
3. Import file Module-excel.bas บน VBA Editor
...
9. Import file Module-powerpoint.bas บน VBA Editor ของ MS. Powerpoint ที่ได้จากผลลัพธ์ในข้อ 8
10. Run macro ชื่อดังนี้ AddText1, AddText2 และ AddText3 สำหรับการสร้าง Textbox และข้อความบนหน้าสไลด์ของ MS. Powerpoint
